...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> resourceIDList=getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] resourceIDs= new Integer[resourceIDList.size()];
					 ...
					 new BroadcastReceiver() {
						 ...
						 public void onReceive(Context context, Intent intent) {
							 ...
							 if (getResultCode()!=MainActivity.IS_ALIVE) {
								...
								PendingIntent contentIntent=PendingIntent.getActivity(mContext,0,restartMainActivityIntent,PendingIntent.FLAG_UPDATE_CURRENT);
